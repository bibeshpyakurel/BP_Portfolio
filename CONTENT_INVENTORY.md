...
This inventory captures the current site content in section order. Content wording is preserved as-is.

## Global / Shell Content
- Site title: `Bibesh Portfolio`
- Skip link text: `Skip to main content`
- Site header brand: `Bibesh Pyakurel`
- Sidebar profile name: `Bibesh Pyakurel`
- Sidebar role line: `Java • Spring Boot • SQL • Python • Azure`
...
- Meta: `Education`
- Heading: `Education`
- Panel 1 title: `Bachelor Degree of Computer Science`
  ...
  - Bullets:
    ...
    - `GPA: 3.8 / 4.0`
- Panel 2 title: `High School in Science Focus`
...
- Entry 3:
  - `Founder & President | Nepalese Students’ Association – UW–Green Bay`
  - `Aug 2024 – Aug 2025`
...
- Entry 6:
  - `Computer Science Intern (Cybersecurity) | Resch School of Engineering`
  - `Feb 2024 – May 2024`
...
- Entry 7:
  - `Resident Assistant | University of Wisconsin–Green Bay`
  - `Jan 2023 – Dec 2025`
...
- Entry 8:
  - `Student PEEP | The Weidner Center`
  - `Feb 2023 – Dec 2025`
...
- Heading: `Projects`
- Project 1:
  - Title: `Pavement Crack Detection | WiSys Project`
  - Summary: `Assisting in the development of Convolutional neural networks (CNN) models for crack detection.`
  - Tags: `June 2023 - Present`, `Deep Learning`
  - Highlights:
    - `Assisting in the development`
    - `Convolutional neural networks (CNN) models`
    - `for crack detection.`
- Project 2:
  - Title: `Blackjack Game Development in Java Language`
  - Summary: `Developed a collaborative java-based game with a user-friendly GUI using Scene Builder.`
  - Tags: `Fall 2023`, `Jave Game Development`
  - Highlights:
    - `Developed a collaborative java-based game`
    - `user-friendly GUI`
    - `Scene Builder.`
- Project 3:
  - Title: `Smart Student App | Android Studio`
  - Summary: `Designed a very simple multi-functioning app in Android Studio. Incorporated native features like emergency calling.`
  - Tags: `Fall 2023`, `Application Development`
  - Highlights:
    - `Designed a very simple multi-functioning app in Android Studio.`
    - `Incorporated native features like emergency calling.`
- Project 4:
  - Title: `Student Budget Calculator | Personal Project`
  - Summary: `Designed a Java-based budget calculator to assist students in tracking their spending.`
  - Tags: `Fall 2023`, `Java & Scene Builder`
  - Highlights:
    - `Designed a Java-based budget calculator`
    - `assist students in tracking their spending.`
- Project 5:
  - Title: `CyberSecurity Labs | Intern Project`
  - Summary: `Engaged in testing labs, exploring critical areas like Buffer Overflow vulnerabilities and atacks, Return-to-libc Attack and ROP. Made an instruction manual for both.`
  - Tags: `Spring 2024`, `CyberSecurity`
  - Highlights:
    - `Buffer Overflow vulnerabilities and atacks`
    - `Return-to-libc Attack and ROP`
    - `Made an instruction manual for both.`
- Project 6:
  - Title: `Database Design | Class Project`
  - Summary: `Designed a database of an online server, created and ER Diagram, and SQL statement.`
  - Tags: `Fall 2023`, `Database Management & SQL`
  - Highlights:
    - `Designed a database of an online server`
    - `created and ER Diagram`
    - `SQL statement.`

## Section: Skills
- Meta: `Core Focus`
- Heading: `Software, Data & AI Skills`
- Intro text:
...
- Cards:
  - `Learn SQL` → `View Certificate`
  - `Generative AI & the Azure Bot AI Service` → `View Certificate`
  - `Microsoft Azure Fundamentals: Monitoring Azure Services` → `View Certificate`
  - `How to Make a Website with NameCheap` → `View Certificate`
  - `What is Data Science?` → `View Certificate`

## Section: Counters
- Heading (screen-reader): `Portfolio Metrics`
- Counter labels:
  - `Work Experiences`
  - `Projects`
  - `Skills`
...
- Heading: `Contact`
- Contact content:
  - Email: `bibespyakurel1100@gmail.com`
  - Location: `United States of America`
  - Phone: `+1(240)254-7082`

## Footer
- Sidebar footer content includes social links only:
  - LinkedIn
  - GitHub
  - Instagram
